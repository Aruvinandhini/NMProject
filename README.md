The GitHub repository https://aruvinandhini.github.io/NMProject/ hosts a Python-based application designed to facilitate voice-based note-taking and memo management.
